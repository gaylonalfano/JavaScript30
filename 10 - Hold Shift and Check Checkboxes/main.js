...
var inboxElement = document.querySelector(".inbox");
...
function handleCheck(e) {
    ...
    var inBetween = false; // Can't access in Console as it's not global scoped
    ...
    if (e.shiftKey && this.checked && lastChecked !== undefined) {
        ...
        checkboxes.forEach(function (checkbox) {
            ...
            if (checkbox === _this || checkbox === lastChecked) {
                ...
                console.assert(checkbox === _this, "!this => lastChecked"); // Assertion failed
